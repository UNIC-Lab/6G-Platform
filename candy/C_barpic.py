...
plt.plot(num_requests_list, dbo_reuse_values, 'o-', color="#B47B84", linewidth=2)
# 设置 X 轴和 Y 轴的主刻度标签只显示整数
plt.gca().xaxis.set_major_locator(ticker.MaxNLocator(integer=True))
plt.gca().yaxis.set_major_locator(ticker.MaxNLocator(integer=True))
plt.xlabel('Number of Requests',fontsize=13)
plt.ylabel('Resource Reuse Rate',fontsize=13)
plt.grid()
plt.savefig('Resource_Reuse_Rate.pdf', bbox_inches='tight')
plt.savefig('Resource_Reuse_Rate.png', bbox_inches='tight', dpi=600, pad_inches=0.0)
...
plt.gca().yaxis.set_major_locator(ticker.MaxNLocator(integer=True))
plt.xlabel('用户请求数量',fontsize=13)
plt.ylabel('资源复用率',fontsize=13)
plt.grid()
plt.savefig('Resource_Reuse_Rate_Chinese.pdf', bbox_inches='tight')
plt.savefig('Resource_Reuse_Rate_Chinese.png', bbox_inches='tight', dpi=600, pad_inches=0.0)
'''